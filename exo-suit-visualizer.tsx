...
// FIX: Cast `this` to `unknown as Element` to satisfy TypeScript's strict type checking.
    new THREE.Color(getComputedStyle(this as unknown as Element).getPropertyValue('--exo-mat-color-1').trim() || '#c0c0c0'),
    new THREE.Color(getComputedStyle(this as unknown as Element).getPropertyValue('--exo-mat-color-2').trim() || '#f0e68c'),
    new THREE.Color(getComputedStyle(this as unknown as Element).getPropertyValue('--exo-mat-color-3').trim() || '#ffb6c1'),
  ];
